...
using AbpPermissionCacheTest.Web.Menus;
...
namespace AbpPermissionCacheTest.Web
{
    ...
    public class AbpPermissionCacheTestWebModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(AbpPermissionCacheTestResource),
                    typeof(AbpPermissionCacheTestDomainSharedModule).Assembly,
                    typeof(AbpPermissionCacheTestApplicationContractsModule).Assembly,
                    typeof(AbpPermissionCacheTestWebModule).Assembly
                );
            });
        }
        ...
        private void ConfigureAuthentication(ServiceConfigurationContext context, IConfigurationRoot configuration)
        {
            context.Services.AddAuthentication(options =>
                ...
                .AddOpenIdConnect("oidc", options =>
                {
                    ...
                    options.Scope.Add("AbpPermissionCacheTest");
        ...
        private void ConfigureAutoMapper()
        {
            Configure<AbpAutoMapperOptions>(options =>
            {
                 ...
                 */
                options.AddProfile<AbpPermissionCacheTestWebAutoMapperProfile>();
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IHostingEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<AbpPermissionCacheTestDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}AbpPermissionCacheTest.Domain"));
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<AbpPermissionCacheTestWebModule>(hostingEnvironment.ContentRootPath);
                });
            }
        }
        ...
        private void ConfigureNavigationServices()
        {
            ...
            {
                options.MenuContributors.Add(new AbpPermissionCacheTestMenuContributor());
            });
        }
